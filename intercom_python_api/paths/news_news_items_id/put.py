...
# body param
SchemaForRequestBodyApplicationJson = NewsItemRequest


request_body_news_item_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = NewsItem
...
class BaseApi(api_client.Api):
    ...
    def _update_news_item_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_news_item_request.serialize(body, content_type)
...
class UpdateNewsItem(BaseApi):
    ...
    def update_news_item(
        ...
        return self._update_news_item_oapg(
            body=body,
