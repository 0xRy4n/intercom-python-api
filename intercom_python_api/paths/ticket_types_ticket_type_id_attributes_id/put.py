...
# Path params
TicketTypeIdSchema = schemas.StrSchema
IdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ticket_type_id': typing.Union[TicketTypeIdSchema, str, ],
...
request_path_ticket_type_id = api_client.PathParameter(
    name="ticket_type_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TicketTypeIdSchema,
    required=True,
)
...
# body param
SchemaForRequestBodyApplicationJson = UpdateTicketTypeAttributeRequest


request_body_update_ticket_type_attribute_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TicketTypeAttribute
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_ticket_type_attribute_oapg(
        self,
    ...
    def _update_ticket_type_attribute_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_ticket_type_attribute_request.serialize(body, content_type)
...
class UpdateTicketTypeAttribute(BaseApi):
    ...
    def update_ticket_type_attribute(
        ...
        return self._update_ticket_type_attribute_oapg(
            body=body,
