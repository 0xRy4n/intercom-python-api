...
# body param
SchemaForRequestBodyApplicationJson = ConvertVisitorRequest


request_body_convert_visitor_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = Contact
...
class BaseApi(api_client.Api):
    ...
    def _convert_visitor_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_convert_visitor_request.serialize(body, content_type)
...
class ConvertVisitor(BaseApi):
    ...
    def convert_visitor(
        ...
        return self._convert_visitor_oapg(
            body=body,
