...
# body param
SchemaForRequestBodyApplicationJson = RedactConversationRequest


request_body_redact_conversation_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _redact_conversation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_redact_conversation_request.serialize(body, content_type)
...
class RedactConversation(BaseApi):
    ...
    def redact_conversation(
        ...
        return self._redact_conversation_oapg(
            body=body,
