...
# Query params
DisplayAsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'display_as': typing.Union[DisplayAsSchema, str, ],
    },
    total=False
)
...
request_query_display_as = api_client.QueryParameter(
    name="display_as",
    style=api_client.ParameterStyle.FORM,
    schema=DisplayAsSchema,
    explode=True,
)
# Header params
...
# body param
SchemaForRequestBodyApplicationJson = UpdateConversationRequest


request_body_update_conversation_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = Conversation
...
class BaseApi(api_client.Api):
    ...
    def _update_conversation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_conversation_request.serialize(body, content_type)
...
class UpdateConversation(BaseApi):
    ...
    def update_conversation(
        ...
        return self._update_conversation_oapg(
            body=body,
