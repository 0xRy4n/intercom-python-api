...
# body param
SchemaForRequestBodyApplicationJson = ReplyConversationRequest


request_body_reply_conversation_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _reply_conversation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_reply_conversation_request.serialize(body, content_type)
...
class ReplyConversation(BaseApi):
    ...
    def reply_conversation(
        ...
        return self._reply_conversation_oapg(
            body=body,
