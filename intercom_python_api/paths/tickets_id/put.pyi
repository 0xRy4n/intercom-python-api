...
# body param
SchemaForRequestBodyApplicationJson = UpdateTicketRequest


request_body_update_ticket_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = Ticket
...
class BaseApi(api_client.Api):
    ...
    def _tickets_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_ticket_request.serialize(body, content_type)
...
class TicketsIdPut(BaseApi):
    ...
    def tickets_id_put(
        ...
        return self._tickets_id_put_oapg(
            body=body,
