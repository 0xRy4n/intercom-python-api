...
# body param
SchemaForRequestBodyApplicationJson = CreateDataExportsRequest


request_body_create_data_exports_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_data_export_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_data_exports_request.serialize(body, content_type)
