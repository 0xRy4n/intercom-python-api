...
# Query params
CreatedAtAfterSchema = schemas.StrSchema
CreatedAtBeforeSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'created_at_after': typing.Union[CreatedAtAfterSchema, str, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        'created_at_before': typing.Union[CreatedAtBeforeSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = ActivityLogList
...
class ListActivityLogs(BaseApi):
    ...
    def list_activity_logs(
        ...
        return self._list_activity_logs_oapg(
