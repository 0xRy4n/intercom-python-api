...
# body param
SchemaForRequestBodyApplicationJson = MergeContactsRequest


request_body_merge_contacts_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _merge_contact_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_merge_contacts_request.serialize(body, content_type)
...
class MergeContact(BaseApi):
    ...
    def merge_contact(
        ...
        return self._merge_contact_oapg(
            body=body,
