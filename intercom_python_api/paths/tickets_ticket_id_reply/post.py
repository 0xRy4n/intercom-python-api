...
SchemaFor200ResponseBodyApplicationJson = TicketNote
...
class BaseApi(api_client.Api):
    @typing.overload
    def _tickets_ticket_id_reply_post_oapg(
        self,
...
class TicketsTicketIdReplyPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def tickets_ticket_id_reply_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def tickets_ticket_id_reply_post(
        ...
        return self._tickets_ticket_id_reply_post_oapg(
            body=body,
