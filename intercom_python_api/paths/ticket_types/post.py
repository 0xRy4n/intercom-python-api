...
# body param
SchemaForRequestBodyApplicationJson = CreateTicketTypeRequest


request_body_create_ticket_type_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _ticket_types_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_ticket_type_request.serialize(body, content_type)
...
class TicketTypesPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def ticket_types_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def ticket_types_post(
        ...
        return self._ticket_types_post_oapg(
            body=body,
