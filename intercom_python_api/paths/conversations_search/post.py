...
SchemaFor200ResponseBodyApplicationJson = ConversationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_conversations_oapg(
        self,
...
class SearchConversations(BaseApi):
    ...
    def search_conversations(
        ...
        return self._search_conversations_oapg(
            body=body,
