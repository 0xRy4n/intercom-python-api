...
# body param
SchemaForRequestBodyApplicationJson = UpdateVisitorRequest


request_body_update_visitor_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = Visitor
...
class BaseApi(api_client.Api):
    ...
    def _update_visitor_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_visitor_request.serialize(body, content_type)
...
class UpdateVisitor(BaseApi):
    ...
    def update_visitor(
        ...
        return self._update_visitor_oapg(
            body=body,
