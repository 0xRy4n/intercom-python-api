...
# body param
SchemaForRequestBodyApplicationJson = CreateSectionRequest


request_body_create_section_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_section_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_section_request.serialize(body, content_type)
