...
SchemaFor200ResponseBodyApplicationJson = CompanyAttachedContacts
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_attached_contacts_oapg(
        self,
...
class ListAttachedContacts(BaseApi):
    ...
    def list_attached_contacts(
        ...
        return self._list_attached_contacts_oapg(
