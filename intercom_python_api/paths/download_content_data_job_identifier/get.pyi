...
# Path params
JobIdentifierSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'job_identifier': typing.Union[JobIdentifierSchema, str, ],
    }
)
...
request_path_job_identifier = api_client.PathParameter(
    name="job_identifier",
    style=api_client.ParameterStyle.SIMPLE,
    schema=JobIdentifierSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_data_export_oapg(
        self,
...
class DownloadDataExport(BaseApi):
    ...
    def download_data_export(
        ...
        return self._download_data_export_oapg(
