...
# body param
SchemaForRequestBodyApplicationJson = UpdateArticleRequest


request_body_update_article_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = Article
...
class BaseApi(api_client.Api):
    ...
    def _update_article_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_article_request.serialize(body, content_type)
...
class UpdateArticle(BaseApi):
    ...
    def update_article(
        ...
        return self._update_article_oapg(
            body=body,
