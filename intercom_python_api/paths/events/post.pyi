...
# body param
SchemaForRequestBodyApplicationJson = CreateDataEventRequest


request_body_create_data_event_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_data_event_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_data_event_request.serialize(body, content_type)
...
class CreateDataEvent(BaseApi):
    ...
    def create_data_event(
        ...
        return self._create_data_event_oapg(
            body=body,
