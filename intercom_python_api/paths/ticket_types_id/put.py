...
# body param
SchemaForRequestBodyApplicationJson = UpdateTicketTypeRequest


request_body_update_ticket_type_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TicketType
...
class BaseApi(api_client.Api):
    ...
    def _ticket_types_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_ticket_type_request.serialize(body, content_type)
...
class TicketTypesIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def ticket_types_id_put(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def ticket_types_id_put(
        ...
        return self._ticket_types_id_put_oapg(
            body=body,
