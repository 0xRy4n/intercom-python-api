...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["admin_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["admin_id", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _detach_tag_from_conversation_oapg(
        self,
...
class DetachTagFromConversation(BaseApi):
    ...
    def detach_tag_from_conversation(
        ...
        return self._detach_tag_from_conversation_oapg(
            body=body,
