...
SchemaFor200ResponseBodyApplicationJson = ContactSegments
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_segments_for_a_contact_oapg(
        self,
...
class ListSegmentsForAContact(BaseApi):
    ...
    def list_segments_for_a_contact(
        ...
        return self._list_segments_for_a_contact_oapg(
