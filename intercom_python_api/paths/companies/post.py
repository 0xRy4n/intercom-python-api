...
# body param
SchemaForRequestBodyApplicationJson = CreateOrUpdateCompanyRequest


request_body_create_or_update_company_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Company
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_or_update_company_oapg(
        self,
    ...
    def _create_or_update_company_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_or_update_company_request.serialize(body, content_type)
...
class CreateOrUpdateCompany(BaseApi):
    ...
    def create_or_update_company(
        ...
        return self._create_or_update_company_oapg(
            body=body,
