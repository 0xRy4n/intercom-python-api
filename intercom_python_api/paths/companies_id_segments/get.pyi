...
SchemaFor200ResponseBodyApplicationJson = CompanyAttachedSegments
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_attached_segments_for_companies_oapg(
        self,
...
class ListAttachedSegmentsForCompanies(BaseApi):
    ...
    def list_attached_segments_for_companies(
        ...
        return self._list_attached_segments_for_companies_oapg(
