...
# Query params
ScrollParamSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'scroll_param': typing.Union[ScrollParamSchema, str, ],
    },
    total=False
)
...
request_query_scroll_param = api_client.QueryParameter(
    name="scroll_param",
    style=api_client.ParameterStyle.FORM,
    schema=ScrollParamSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = CompanyScroll
...
class BaseApi(api_client.Api):
    @typing.overload
    def _scroll_over_all_companies_oapg(
        self,
...
class ScrollOverAllCompanies(BaseApi):
    ...
    def scroll_over_all_companies(
        ...
        return self._scroll_over_all_companies_oapg(
