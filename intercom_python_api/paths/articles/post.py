...
# body param
SchemaForRequestBodyApplicationJson = CreateArticleRequest


request_body_create_article_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_article_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_article_request.serialize(body, content_type)
...
class CreateArticle(BaseApi):
    ...
    def create_article(
        ...
        return self._create_article_oapg(
            body=body,
