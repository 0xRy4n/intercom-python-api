...
SchemaFor200ResponseBodyApplicationJson = CollectionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_all_collections_oapg(
        self,
...
class ListAllCollections(BaseApi):
    ...
    def list_all_collections(
        ...
        return self._list_all_collections_oapg(
