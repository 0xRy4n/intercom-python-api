...
SchemaFor200ResponseBodyApplicationJson = PaginatedResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_live_newsfeed_items_oapg(
        self,
...
class ListLiveNewsfeedItems(BaseApi):
    ...
    def list_live_newsfeed_items(
        ...
        return self._list_live_newsfeed_items_oapg(
