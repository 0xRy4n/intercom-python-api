...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["admin_id", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["admin_id", "id", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _attach_tag_to_conversation_oapg(
        self,
...
class AttachTagToConversation(BaseApi):
    ...
    def attach_tag_to_conversation(
        ...
        return self._attach_tag_to_conversation_oapg(
            body=body,
