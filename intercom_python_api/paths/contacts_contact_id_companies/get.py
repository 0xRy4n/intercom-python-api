...
SchemaFor200ResponseBodyApplicationJson = ContactAttachedCompanies
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_companies_for_a_contact_oapg(
        self,
...
class ListCompaniesForAContact(BaseApi):
    ...
    def list_companies_for_a_contact(
        ...
        return self._list_companies_for_a_contact_oapg(
