...
# body param
SchemaForRequestBodyApplicationJson = CreateConversationRequest


request_body_create_conversation_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_conversation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_conversation_request.serialize(body, content_type)
