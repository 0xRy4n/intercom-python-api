...
class Collection(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "name", "description", "created_at", "updated_at", "url", "icon", "order", "default_locale", "translated_content", "parent_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "name", "description", "created_at", "updated_at", "url", "icon", "order", "default_locale", "translated_content", "parent_id", ], str]):
