...
class CreateTicketTypeRequest(
  ...
  The `icon` property can be copied easy from [Twemoji Cheatsheet](https://twemoji-cheatsheet.vercel.app/).
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "icon", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "icon", ], str]):
