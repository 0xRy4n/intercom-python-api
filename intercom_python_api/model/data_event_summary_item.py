...
class DataEventSummaryItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count", "description", "first", "last", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count", "description", "first", "last", "name", ], str]):
