...
class NewsItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["body", "cover_image_url", "created_at", "deliver_silently", "id", "labels", "newsfeed_assignments", "reactions", "sender_id", "state", "title", "type", "updated_at", "workspace_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["body", "cover_image_url", "created_at", "deliver_silently", "id", "labels", "newsfeed_assignments", "reactions", "sender_id", "state", "title", "type", "updated_at", "workspace_id", ], str]):
