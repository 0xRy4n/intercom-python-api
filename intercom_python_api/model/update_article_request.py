...
class UpdateArticleRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["author_id", "body", "description", "parent_id", "parent_type", "state", "title", "translated_content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["author_id", "body", "description", "parent_id", "parent_type", "state", "title", "translated_content", ], str]):
