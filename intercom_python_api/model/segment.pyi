...
class Segment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count", "created_at", "id", "name", "person_type", "type", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count", "created_at", "id", "name", "person_type", "type", "updated_at", ], str]):
