...
class TicketNote(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attachments", "author", "body", "created_at", "id", "part_type", "redacted", "type", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attachments", "author", "body", "created_at", "id", "part_type", "redacted", "type", "updated_at", ], str]):
