...
class UpdateCollectionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "translated_content", "parent_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "translated_content", "parent_id", ], str]):
