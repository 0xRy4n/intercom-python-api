...
class CreateArticleRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["author_id", "title", "body", "description", "parent_id", "parent_type", "state", "translated_content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["author_id", "title", "body", "description", "parent_id", "parent_type", "state", "translated_content", ], str]):
