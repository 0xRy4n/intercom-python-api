...
Newsfeeds currently cannot be edited through the API, please refer to [this article](https://www.intercom.com/help/en/articles/6362267-getting-started-with-news) to set up your newsfeeds in Intercom.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "id", "name", "type", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "id", "name", "type", "updated_at", ], str]):
