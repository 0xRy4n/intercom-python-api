...
class TicketTypeAttribute(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "id", "workspace_id", "name", "description", "data_type", "input_options", "order", "required", "default", "ticket_type_id", "archived", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "id", "workspace_id", "name", "description", "data_type", "input_options", "order", "required", "default", "ticket_type_id", "archived", "created_at", "updated_at", ], str]):
