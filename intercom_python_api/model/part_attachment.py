...
class PartAttachment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "name", "url", "content_type", "filesize", "width", "height", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "name", "url", "content_type", "filesize", "width", "height", ], str]):
