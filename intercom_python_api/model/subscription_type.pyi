...
class SubscriptionType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["consent_type", "content_types", "default_translation", "id", "state", "translations", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["consent_type", "content_types", "default_translation", "id", "state", "translations", "type", ], str]):
