...
from intercom_python_api import rest
from intercom_python_api.configuration import Configuration
from intercom_python_api.exceptions import ApiTypeError, ApiValueError
from intercom_python_api.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class OpenApiResponse(JSONDetector):
    ...
    def deserialize(self, response: urllib3.HTTPResponse, configuration: Configuration) -> ApiResponse:
         # NOTE: Manual patch - split on semicolon so charset doesnt break comp - Ry4n
