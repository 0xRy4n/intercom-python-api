# intercom_python_api.model.update_section_request.UpdateSectionRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | You can update a Section | 
...
**parent_id** | decimal.Decimal, int,  | decimal.Decimal,  | The id for the collection this section will be within. | [optional] 
